...
This app was created for the Airbyte + Motherduck Hackathon in 2025, getting second place: [And the winner of the Airbyte+Motherduck Hackathon is.....](https://airbyte.com/blog/and-the-winner-of-the-airbyte-motherduck-hackathon-is). 


![image](hackathon.png)

It uses Open Government Data (OGD) of the city of Zurich, Switzerland: [Open Data Zurich](https://data.stadt-zuerich.ch/).
